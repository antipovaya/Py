...
#     return max([i for i in list1 if i[0] != i[1]], key=lambda x: x[0] * x[1])
#
#
# print(find_farthest_orbit(orbits))


# еще один вариант записи этого списка с картежами

# orbits = [(1, 3), (2.5, 10), (7, 2), (6, 6), (4, 3)]
# print(max([(a, b) for a, b in orbits if a != b], key=lambda a, b: a * b))
