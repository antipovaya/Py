...
def write_1(nm):
    ...
    with open(nm, 'a', encoding='utf8') as data:
        data.write(f'{info_user[0]} - {info_user[1]} - {info_user[2]} - {info_user[3]} \n')
...
def find_del(nm, i):
    ...
    del lines[i]
    with open(nm, "w", encoding='utf-8') as data:
...
def find_mod(nm, i):
    ...
    with open(nm, "a", encoding='utf-8') as data:
        data.writelines(f'{mod_line}\n')
